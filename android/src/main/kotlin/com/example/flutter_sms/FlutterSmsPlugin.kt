...
class FlutterSmsPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  private fun canSendSMS(): Boolean {
    ...
    val activityInfo = intent.resolveActivityInfo(act.packageManager, intent.flags.toInt())
  ...
  private fun sendSMSDirect(result: Result, phones: String, message: String) {
    ...
    val sentIntent = PendingIntent.getBroadcast(act, 0, Intent("SMS_SENT_ACTION"), PendingIntent.FLAG_IMMUTABLE)
